...
const columns = [
  ...
  { id: "product", label: "CATEGORY IMAGE", minWidth: 80 },
  { id: "category", label: "CATEGORY NAME", minWidth: 150 },
  { id: "subCategory", label: "SUB CATEGORY NAME", minWidth: 150 },
...
const SubCatList = () => {
  ...
  const [rows, setRows] = React.useState([
    createData(1, "", "Suit", "Organza", "₹499", "₹299", 85),
    createData(2, "Vegetable Steamer for Cooking", "Suit", "Georgette", "₹499", "₹299", 85),
    createData(3, "Vegetable Steamer for Cooking", "Suit", "Silk", "₹499", "₹299", 85),
     createData(4, "", "Suit", "Banarsi", "₹499", "₹299", 85),
    createData(5, "Vegetable Steamer for Cooking", "Suit", "Cotton", "₹499", "₹299", 85),
    createData(6, "Vegetable Steamer for Cooking", "Suit", "Chinnon", "₹499", "₹299", 85),
     ...
     <div className="card my-5 shadow-md sm:rounded-lg bg-white">
        <div className="px-4 py-5 sm:px-6 flex items-center justify-between">
          ...
          <div className="col w-[15%] ml-auto flex items-center gap-2">
            ...
            <TooltipMUI title="Add New Sub Category" placement="top">
